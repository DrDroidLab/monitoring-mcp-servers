...
celery -A agent worker --concurrency=$WORKER_COUNT -l INFO -Ofair -Q $QUEUE --max-tasks-per-child=$WORKER_MAX_TASKS_PER_CHILD --prefetch-multiplier=$WORKER_PREFETCH_MULTIPLIER