...
class ElasticSearch(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["cat_indices", b"cat_indices", "cat_thread_pool_search", b"cat_thread_pool_search", "check_cluster_health", b"check_cluster_health", "monitoring_cluster_stats", b"monitoring_cluster_stats", "node_stats", b"node_stats", "query_logs", b"query_logs", "task", b"task"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cat_indices", b"cat_indices", "cat_thread_pool_search", b"cat_thread_pool_search", "check_cluster_health", b"check_cluster_health", "monitoring_cluster_stats", b"monitoring_cluster_stats", "node_stats", b"node_stats", "query_logs", b"query_logs", "task", b"task", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["task", b"task"]) -> typing.Literal["query_logs", "check_cluster_health", "node_stats", "cat_indices", "cat_thread_pool_search", "monitoring_cluster_stats"] | None: ...
