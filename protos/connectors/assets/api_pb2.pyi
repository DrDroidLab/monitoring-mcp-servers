...
class FetchAssetRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["meta", b"meta", "name", b"name"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["connector_type", b"connector_type", "meta", b"meta", "name", b"name"]) -> None: ...
