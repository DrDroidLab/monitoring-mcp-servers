...
from protos.playbooks.playbook_commons_pb2 import PlaybookTaskResult, PlaybookTaskResultType, TableResult, ApiResponseResult
            ...
            ArgoCD.TaskType.FETCH_DEPLOYMENT_INFO: {
                ...
                'form_fields': [
                    FormField(key_name=StringValue(value="count"),
                              ...
                              default_value=Literal(literal_type=LiteralType.LONG, long=Int64Value(value=10)),
                    ...
                    FormField(key_name=StringValue(value="time_since_in_minutes"),
                              ...
                              data_type=LiteralType.LONG,
                              default_value=Literal(literal_type=LiteralType.LONG, long=Int64Value(value=1440)),
                              form_field_type=FormFieldType.TEXT_FT),
