...
# from integrations.source_api_processors.pd_api_processor import PdApiProcessor
...
#
#     def __init__(self, api_key, configured_email, connector_name: str = None):
#         self.__client = PdApiProcessor(api_key, configured_email)
#         super().__init__(connector_name, Source.PAGER_DUTY)
#
#     @log_function_call
