...
from integrations.source_processors.datadog_oath_api_processor import DatadogOauthApiProcessor
...
class DatadogOauthSourceMetadataExtractor(SourceMetadataExtractor):

    def __init__(self, dd_app_key, dd_api_key, dd_api_domain='datadoghq.com', account_id=None, connector_id=None):
